      ...
      <header className={`fixed top-0 w-full bg-orange-500 transition-all duration-500 ${showHeader ? 'bg-orange-500 bg-opacity-70' : '-translate-y-full'}`}>
        <nav className="flex justify-around items-center p-4">
          ...
          <div className="space-x-6 text-white overflow-hidden max-sm:hidden max-md:hidden">
            <a className="hover:border-b-3 border-white" href="#">Work</a>
            <a className="hover:border-b-3 border-white" href="#">About</a>
            <a className="hover:border-b-3 border-white" href="#">Services</a>
            <a className="hover:border-b-3 border-white" href="#">Ideas</a>
            <a className="hover:border-b-3 border-white" href="#">Careers</a>
            <a className="hover:border-b-3 border-white" href="#">Contact</a>
          </div>
        </nav>
      </header>
